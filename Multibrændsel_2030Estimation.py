...
for gas_entry in GasSpotPrices:
    ...
    fixedGasPrice = round((gas_entry['PurchasePriceDKK_kWh']  + gasafgift) / efficiencyGas, 3)  
    ...
    for electricity_entry in filtered_electricity_entries:
        ...
        if electricity_entry_time in calculatePricesWhenHour:
            ...
            if ElectricitySpotPriceAverage < fixedGasPrice:
                valueprint = "Electricity ({}, {}, {}%)".format(ElectricitySpotPriceAverage, fixedGasPrice,round(((fixedGasPrice - ElectricitySpotPriceAverage)/fixedGasPrice)*100,1))
                mixedUsagePriceDay.append(ElectricitySpotPriceAverage)
            else:
                valueprint = "Gas ({}, {}, {}%)".format(ElectricitySpotPriceAverage, fixedGasPrice,round(((ElectricitySpotPriceAverage - fixedGasPrice)/fixedGasPrice)*100,1))
...
existing_header = ["Day",'00:00-02:00', '02:00-04:00', '04:00-06:00', '06:00-08:00', '08:00-10:00', '10:00-12:00', '12:00-14:00', '14:00-16:00', '16:00-18:00', '18:00-20:00', '20:00-22:00', '22:00-23:59', "Only on Gas (DKK/kWh)", "Mixed usage (DKK/kWh)", 'Potential savings (%)']
header_row.extend(["Only on Gas (DKK/kWh)", "Mixed usage (DKK/kWh)", "Potential savings (%)"])
